...
class MixedDataViewController: UIViewController {
    ...
    var data: [Any] = [
        ...
        UserInfo(pk: 2, name: "Ryan Olson", handle: "ryanolsonk"),
        "Praesent commodo cursus magna, vel scelerisque nisl consectetur et.",
        UserInfo(pk: 4, name: "Oliver Rickard", handle: "ocrickard"),
        ...
        UserInfo(pk: 3, name: "Jesse Squires", handle: "jesse_squires"),
        ...
        UserInfo(pk: 1, name: "Ryan Nystrom", handle: "_ryannystrom")
    ]
...
extension MixedDataViewController: ListAdapterDataSource {
    ...
    func listAdapter(_ listAdapter: ListAdapter, sectionControllerFor object: Any) -> ListSectionController {
        switch object {
        case is String:   return ExpandableSection()
        case is GridItem: return GridSection(isReorderable: true)
        default:          return UserSection(isReorderable: true)
        }
    }
